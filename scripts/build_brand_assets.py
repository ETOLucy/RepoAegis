...
WING = curved_polygon(
    (120, 169),
    [
        ((117, 134), (110, 96), (126, 61)),
        ((151, 34), (181, 27), (205, 35)),
        ((191, 73), (172, 110), (143, 141)),
        ((137, 150), (127, 161), (120, 169)),
    ],
)
WING_OPENING = curved_polygon(
    (122, 153),
    [
        ((129, 119), (145, 83), (166, 55)),
        ((146, 91), (135, 123), (128, 151)),
        ((126, 152), (124, 153), (122, 153)),
    ],
)
SEED = curved_polygon(
    (39, 184),
    [
        ((38, 163), (50, 147), (69, 145)),
        ((88, 143), (103, 157), (104, 176)),
        ((105, 195), (91, 210), (72, 212)),
        ((53, 214), (40, 203), (39, 184)),
    ],
)
SMALL_WING = curved_polygon(
    (130, 169),
    [
        ((127, 134), (119, 96), (133, 61)),
        ((153, 38), (181, 29), (205, 36)),
        ((189, 76), (170, 111), (142, 141)),
        ((140, 151), (135, 162), (130, 169)),
    ],
)
SMALL_SEED = curved_polygon(
    (38, 185),
    [
        ((37, 163), (50, 146), (70, 144)),
        ((91, 142), (106, 157), (107, 177)),
        ((108, 197), (93, 213), (72, 215)),
